...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td><code>https://api.flip.id/kyc/api/v1/users/:agent-id/repairSelfie</code></td>
    </tr>
    <tr>
      <td>Sandbox URL</td>
      <td><code>https://api.flip.id/kyc-sandbox/api/v1/users/:agent-id/repairSelfie</code></td>
    </tr>
  </tbody>
</table>
...
<h3 id="repair-identity-selfie-image-request-parameters">Request Parameters</h3>
  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        Agent's selfie with ID card image file that wants to be uploaded.
        <table class="validation-table">
          <thead>
            <tr>
              <th>Validation</th>
...
<h3 id="repair-identity-selfie-image-response-body">Response Body</h3>
